...
CREATE INDEX "idx_assistants_email" ON "public"."assistants" USING "btree" ("email");
...
CREATE POLICY "Anon can read assistants for login" ON "public"."assistants" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Anon can read profiles for portal" ON "public"."profiles" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Assistants can manage their own record (Admin Fix)" ON "public"."assistants" TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Assistants can view access records directed to them" ON "public"."assistant_access" FOR SELECT USING (("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
...
CREATE POLICY "Auth users can view assistants directory (Admin Fix)" ON "public"."assistants" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can insert assistant_access" ON "public"."assistant_access" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can insert assistants" ON "public"."assistants" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can update assistants" ON "public"."assistants" FOR UPDATE TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Makeup artists can view their own access records" ON "public"."assistant_access" FOR SELECT USING (("makeup_artist_id" IN ( SELECT "makeup_artists"."id"
   FROM "public"."makeup_artists"
  WHERE ("makeup_artists"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert their own makeup_artist profile" ON "public"."makeup_artists" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can read assistants they have access to" ON "public"."assistants" FOR SELECT TO "authenticated" USING (true);
