...
const registerSchema = z.object({
  fullName: z.string().trim().min(2, { message: 'Nome precisa ter pelo menos 2 caracteres' }),
    ...
    >
      <div className="space-y-6 text-left">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="fullname" className="block text-xs text-white/50 mb-1.5">
              Seu nome
            </Label>
            <Input
              id="fullname"
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-center gap-4 justify-center">
            {[
              ...
              <span key={text} className="flex items-center gap-1.5 text-[11px] text-white/25">
