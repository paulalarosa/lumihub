...
import type { Contract, ProjectWithRelations, ProjectServiceItem } from '@/types/api.types';
...
export function ContratosTab({ projectId, contracts, setContracts, loading, project, projectServices, totalValue }: ContratosTabProps) {
    const {
        ...
        handleArchitectMode,
        handleEditorMode
    } = useContratos({ projectId, project, projectServices, totalValue, setContracts });
