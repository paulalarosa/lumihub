...
import { CommissionTable, AssistantCommission } from './components/CommissionTable';
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-xl font-bold text-white">Gestão Financeira e Comissões</h2>
                        <p className="text-gray-400 text-sm">Fechamento de {format(new Date(), 'MMMM yyyy', { locale: ptBR })}</p>
                    </div>
                    <Button
                    ...
                    >
                        {dataLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Download className="w-4 h-4 mr-2" />}
