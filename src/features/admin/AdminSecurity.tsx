    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-black border border-white/20 rounded-none md:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <div>
              <CardTitle className="text-lg font-bold text-white font-serif tracking-tight">
                Encrypted Backup
              </CardTitle>
              <CardDescription className="text-gray-500 text-xs font-mono">
                Military-grade AES-256 encryption. Full DB dump.
              </CardDescription>
            </div>
          ...
          <Card className="bg-black border border-white/20 rounded-none">
            <CardHeader className="flex flex-row items-center justify-between border-b border-white/10 pb-4">
              ...
              <Button
                ...
                size="sm"
                onClick={fetchLogs}
                className="text-gray-500 hover:text-white rounded-none"
              >
                <RefreshCw
                  ...
                  logs.map((log) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <Badge
                          variant="outline"
                          className="text-[10px] font-mono border-green-900 text-green-500 bg-green-900/10 rounded-none h-4 px-1"
                        >
                          AUDITED
                        </Badge>
                      </div>
