    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-black border border-red-900/30 rounded-none relative overflow-hidden group">
          ...
          <CardHeader className="relative z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <AlertOctagon
                  className={`h-5 w-5 ${configs.maintenance_mode ? 'text-red-500' : 'text-gray-500'}`}
                />
                <CardTitle className="text-white font-serif tracking-tight">
                  System Lock
                </CardTitle>
              </div>
              <Switch
          ...
          <CardContent className="relative z-10">
            <p className="text-gray-400 text-xs font-mono">
              When active, only Admin users can access the platform. All other
              sessions will be terminated or blocked.
            </p>
            {configs.maintenance_mode && (
              <Badge
                variant="outline"
                className="mt-4 border-red-500 text-red-500 animate-pulse bg-red-950/30 rounded-none"
              >
                ACTIVE LOCKDOWN
              </Badge>
            )}
        ...
        <Card className="bg-black border border-white/20 rounded-none">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleSave('allow_registrations', checked)
                }
              />
            </div>
          ...
          <CardContent>
            <p className="text-gray-400 text-xs font-mono">
              Enable or disable public signup forms. Existing invitations will
              still function.
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="bg-black border border-white/20 rounded-none">
        ...
        <CardContent>
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setConfigs((prev) => ({
                    ...prev,
                    global_alert_message: e.target.value,
                  }))
                }
            ...
            <Button
              onClick={() =>
                handleSave('global_alert_message', configs.global_alert_message)
              }
          ...
          <p className="text-gray-500 text-[10px] font-mono mt-2">
            This message will appear as a banner on all user dashboards
            immediately. Leave empty to disable.
          </p>
        </CardContent>
      </Card>
    </div>
