...
const PLANS = [
  {
    ...
    price: 39.9,
    popular: false,
    stripePriceId: 'price_1T1EbjLrk3pIMja5u0UtzmG4',
    features: [
  ...
  },
  {
    ...
    price: 89.9,
    popular: true,
    stripePriceId: 'price_1T1EbjLrk3pIMja5HuONOIFi',
    features: [
      'Agenda ilimitada',
      'Clientes ilimitados',
      'Contratos digitais com assinatura',
  ...
  },
  {
    ...
    price: 149.9,
    popular: false,
    stripePriceId: 'price_1T1EbmLrk3pIMja5DbScVvvW',
    features: [
      'Tudo do Plano Profissional',
      'Equipe + comissões automáticas',
      'Multi-usuário',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
            De assistente a empreendedora. Gerencie seus próprios clientes,
            agenda e financeiro com a plataforma mais completa do mercado.
          </p>
        </div>
          ...
          <div className="grid gap-6 max-w-3xl mx-auto">
            <div>
              ...
              <p className="text-neutral-400 text-sm">
                Sim! Não há fidelidade. Você pode cancelar sua assinatura quando
                quiser e continuar usando até o fim do período pago.
              </p>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-2">
              ...
              <p className="text-neutral-400 text-sm">
                Sim! Ao fazer upgrade, você mantém todo o histórico de eventos e
                informações que tinha como assistente, além de ganhar acesso
                completo à plataforma.
              </p>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-2">É seguro?</h3>
              <p className="text-neutral-400 text-sm">
                Sim! Utilizamos a Stripe, líder mundial em pagamentos online,
                garantindo a proteção total dos seus dados.
              </p>
            </div>
          </div>
        </div>
