import { CreateMLCEngine, type MLCEngine, type ChatOptions, type ChatCompletionRequest } from "@mlc-ai/web-llm";
...
export class WebLLMProvider implements LanguageModelV1 {
    ...
    constructor(modelId: string = "Llama-3-8B-q4f16_1-MLC", onProgress?: (report: any) => void) {
...
export const createWebLLM = (modelId?: string, onProgress?: (report: any) => void) => {
