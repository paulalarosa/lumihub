        ...
        return (
            <div className="min-h-screen bg-[#050505] flex items-center justify-center p-8">
                <div className="max-w-md w-full border border-neutral-800 p-8 text-center bg-black">
                    ...
                    <h1 className="text-xl font-serif text-white uppercase tracking-widest mb-4">Acesso Restrito</h1>
                    <p className="text-sm text-neutral-500 font-mono mb-8">{error || "Não foi possível carregar os dados."}</p>
                    <Button
                        onClick={() => navigate('/')}
            ...
            <main className="container mx-auto px-6 py-12 md:py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-neutral-900 border border-neutral-900">
                    ...
                    <div className="bg-[#050505] p-12 aspect-square flex flex-col justify-between group hover:bg-neutral-950 transition-colors">
                        <div>
                            <span className="text-[10px] uppercase tracking-[0.3em] text-neutral-600 block mb-2">01</span>
                            <h2 className="text-2xl font-serif text-white italic">Cronograma</h2>
                        </div>
                        <p className="text-sm text-neutral-500 font-mono leading-relaxed max-w-xs mt-4">
                            Visualize o passo a passo do seu grande dia. Detalhes milimetricamente planejados.
                        </p>
                        <div className="mt-8 flex justify-end">
                            <Button variant="outline" className="rounded-none border-neutral-800 text-neutral-400 hover:text-white hover:border-white uppercase text-[10px] tracking-widest">
                                Ver Detalhes
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#050505] p-12 aspect-square flex flex-col justify-between group hover:bg-neutral-950 transition-colors">
                        <div>
                            <span className="text-[10px] uppercase tracking-[0.3em] text-neutral-600 block mb-2">02</span>
                            <h2 className="text-2xl font-serif text-white italic">Documentos</h2>
                        </div>
                        <p className="text-sm text-neutral-500 font-mono leading-relaxed max-w-xs mt-4">
