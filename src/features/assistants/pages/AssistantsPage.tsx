...
import { ArrowLeft, Plus, Users, Shield, UserPlus } from 'lucide-react';
...
export default function AssistantsPage() {
    ...
    if (authLoading) return <div className="h-screen bg-black flex items-center justify-center"><div className="animate-spin h-8 w-8 border-t-2 border-white rounded-full"></div></div>;
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center space-x-4">
                            <Link to="/agenda">
                                <Button variant="ghost" size="icon" className="hover:bg-white/10 rounded-none text-white h-10 w-10">
                        ...
                        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                            ...
                            <DialogContent className="bg-[#0A0A0A] border-white/10 text-white rounded-none sm:max-w-md">
                                <DialogHeader>
                                    <DialogTitle className="font-serif text-xl tracking-wide">Convidar Nova Assistente</DialogTitle>
                                </DialogHeader>
                    ...
                    <Card className="bg-[#0A0A0A] border-white/5 rounded-none shadow-none">
                        <CardHeader className="pb-4 border-b border-white/5">
                            ...
                            <CardDescription className="text-gray-500 font-mono text-xs uppercase tracking-wider">
                                Gerencie quem tem acesso à sua agenda e remova permissões quando necessário.
                            </CardDescription>
                        </CardHeader>
                ...
                <div className="space-y-6">
                    <div className="sticky top-24 space-y-6">
                        ...
                        <div className="p-5 border border-white/5 bg-white/[0.02] rounded-none">
                            <h4 className="font-bold text-sm mb-3 text-white uppercase tracking-wider border-b border-white/10 pb-2">Como funciona?</h4>
                            <ul className="text-xs text-gray-400 space-y-3 list-none">
                                <li className="flex gap-2">
                                    <span className="text-white/50">01.</span>
                                    <span>Envie um convite por e-mail através do botão acima.</span>
                                </li>
                                <li className="flex gap-2">
                                    <span className="text-white/50">02.</span>
                                    <span>A assistente receberá um link único para criar a conta.</span>
                                </li>
                                <li className="flex gap-2">
                                    <span className="text-white/50">03.</span>
                                    <span>Após o cadastro, ela terá acesso restrito à sua agenda.</span>
                                </li>
                                <li className="flex gap-2">
                                    <span className="text-white/50">04.</span>
                                    <span>Você pode revogar o acesso imediatamente a qualquer momento.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
