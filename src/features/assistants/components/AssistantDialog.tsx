...
interface AssistantDialogProps {
    ...
    onSave: (data: { name: string, email: string | null, phone: string | null }) => Promise<void>;
}

export function AssistantDialog({ open, onOpenChange, assistant, onSave }: AssistantDialogProps) {
