...
export default function DashboardHome() {
  ...
  const isEmptyState =
    !loading && leadsConversion.total === 0 && totalBudgets === 0

  const metrics = [
    {
      label: 'Orçamentos Geridos',
      value: totalBudgets.toLocaleString('pt-BR', {
        style: 'currency',
        currency: 'BRL',
      }),
    ...
    {
      label: 'Ticket Médio',
      value: avgWeddingValue.toLocaleString('pt-BR', {
        style: 'currency',
        currency: 'BRL',
      }),
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col gap-2 mb-8">
        ...
        <h1 className="text-white font-serif text-4xl">Dashboard</h1>
      </div>
