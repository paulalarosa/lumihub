    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {metrics.map((metric, index) => (
                <div key={index} className="bg-[#000000] border border-[#222222] p-6 flex flex-col justify-between h-32 hover:border-[#444444] transition-colors duration-300 group">
