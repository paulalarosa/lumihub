          ...
          <div className="max-w-3xl mx-auto border-l border-white/20 pl-8 md:pl-12 py-4">
            ...
            <div className="space-y-12 font-sans font-light text-gray-300 leading-relaxed text-sm md:text-base">
              <section className="space-y-4">
                ...
                <p>
                  Coletamos informações essenciais para a operação do Sistema
                  ("Data Points"), incluindo: dados de cadastro (nome, email,
                  telefone), dados financeiros para processamento de pagamentos
                  e dados de uso da plataforma para melhoria contínua da
                  experiência.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-4 space-y-2 marker:text-white/50">
                  ...
                  <li>
                    Notificar sobre atualizações do sistema (System Updates);
                  </li>
                  <li>Prevenir fraudes e garantir a segurança da rede;</li>
                  <li>
                    <strong>Integração com Google Calendar:</strong> O uso de
                    informações recebidas das APIs do Google aderirá à
                    <a
                    ...
                    , incluindo os requisitos de Uso Limitado. Utilizamos o
                    escopo <em>calendar.events.readonly</em> apenas para exibir
                    seus eventos dentro do painel, sem armazenar dados
                    externamente de forma permanente.
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p>
                  O KONTROL não vende ou aluga seus dados pessoais. O
                  compartilhamento ocorre apenas com parceiros essenciais para a
                  execução do serviço (ex: gateways de pagamento, serviços de
                  hospedagem), que são obrigados contratualmente a manter o
              ...
              <section className="space-y-4">
                <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-white mb-6">
                  04. SEGURANÇA (ENCRYPTION)
                </h2>
                <p>
                  Implementamos medidas de segurança técnicas e organizacionais
                  ("Military Grade") para proteger seus dados contra acesso não
              ...
              <section className="space-y-4">
                <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-white mb-6">
                  05. COOKIES & RASTREAMENTO
                </h2>
                <p>
                  Utilizamos cookies e tecnologias similares para rastrear a
                  atividade em nosso Sistema e manter certas informações. Você
                  pode instruir seu navegador a recusar todos os cookies, mas
                  isso pode limitar funcionalidades da plataforma.
                </p>
              </section>
