                    ...
                    <div className="max-w-3xl mx-auto border-l border-white/20 pl-8 md:pl-12 py-4">
                        ...
                        <div className="space-y-12 font-sans font-light text-gray-300 leading-relaxed text-sm md:text-base">
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    É estritamente proibido: (a) copiar, modificar ou criar obras derivadas do Sistema; (b) fazer engenharia reversa
                                    ou tentar extrair o código-fonte; (c) vender, alugar ou sublicenciar o acesso ao Sistema sem autorização.
                                </p>
                            </section>

                            <section className="space-y-4">
                                <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-white mb-6">03. RESPONSABILIDADES DA CONTA</h2>
                                <p>
                                    O usuário é o único responsável por manter a confidencialidade de suas credenciais de acesso de "Nível de Comando".
                            ...
                            <section className="space-y-4">
                                <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-white mb-6">04. PAGAMENTOS E ASSINATURAS</h2>
                                <p>
                                    Os planos de acesso são cobrados mensalmente. O não pagamento resultará no bloqueio temporário das
                                    funcionalidades premium até a regularização. Não há contrato de fidelidade e o cancelamento pode ser
                                    solicitado a qualquer momento através do painel de controle.
                                </p>
                            </section>
