...
export default function InviteLanding() {
  ...
  const { status, inviteData, loading, formData, setFormData, handleRegister } =
    useInviteLanding()
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full border border-neutral-800 bg-black p-12 text-center relative overflow-hidden">
          ...
          <h2 className="text-xl font-serif text-white tracking-widest uppercase mb-2">
            Convite Inválido
          </h2>
          ...
          <Button
            ...
            className="w-full rounded-full bg-white/10 text-white hover:bg-white/20 backdrop-blur-md border border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] font-bold uppercase tracking-widest"
          >
            Voltar ao Início
          </Button>
        </div>
        ...
        <div className="relative bg-black border border-neutral-800 p-8 md:p-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-6 text-sm text-neutral-400 font-mono leading-relaxed">
              ...
              <SEOHead
                title="Você foi convidado | KHAOS KONTROL"
                description="Seu profissional de beleza convidou você para o KHAOS KONTROL. Gerencie seus agendamentos e contratos em um só lugar."
              />
              <br />
              <span className="text-white">
                Confirme suas credenciais para acessar o império.
              </span>
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label
                  htmlFor="invite-name"
                  className="text-[10px] uppercase tracking-widest text-neutral-400 font-bold"
                >
                  Nome Completo
                </label>
                <Input
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-14 bg-white/10 text-white hover:bg-white/20 backdrop-blur-md border border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] rounded-full font-bold uppercase tracking-[0.2em] text-xs transition-all active:scale-[0.99]"
            >
              {loading ? (
