        ...
        <div className="p-6 min-h-screen bg-black text-white selection:bg-yellow-500 selection:text-black">
            <div className="mb-8">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="font-mono uppercase tracking-[0.3em] text-yellow-500 text-xs">System Area</span>
                </div>
            ...
            <Tabs defaultValue="clients" className="w-full">
                    ...
                    <div className="mb-12 p-6 border border-white/10 bg-white/5 rounded-none relative group">
                        <div className="flex flex-col gap-6">
                            <div className="flex items-center justify-between">
                                <h3 className="font-mono text-white/60 text-sm uppercase tracking-wider">Client Management</h3>
                            </div>
                            <SearchBar />
                            <ClientsTable />
                        </div>
                ...
                <TabsContent value="logs" className="mt-0">
                    <div className="p-6 border border-white/10 bg-white/5 rounded-none">
                        <h3 className="font-mono text-white/60 text-sm uppercase tracking-wider mb-6">Recent System Activity</h3>
                        <SystemLogs />
                    </div>
                </TabsContent>
            </Tabs>
