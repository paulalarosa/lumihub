...
const TRIGGER_TYPES = [
    { value: 'booking_confirmation', label: 'Confirmação de Reserva', icon: '✅' },
...
export const FollowUpManager = () => {
    ...
    return (
        <div className="container mx-auto p-8 animate-in fade-in duration-500">
            <h1 className="text-3xl font-bold mb-8 text-white">Automação de Follow-ups</h1>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        <span className="text-2xl">
                                            {TRIGGER_TYPES.find(t => t.value === template.trigger_type)?.icon || '📝'}
                                        </span>
                ...
                {selectedTemplate ? (
                    <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-6">
                        <h2 className="text-xl font-semibold mb-4 text-white">Editar Template</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-2 text-gray-300">Canal</label>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setSelectedTemplate({ ...selectedTemplate, send_at_time: e.target.value })
                                    }
                                    className="bg-neutral-800 border-neutral-700 text-white"
                                />
                            ...
                            <div className="bg-neutral-800 rounded-lg p-4 border border-neutral-700">
                                <p className="text-sm font-medium mb-2 text-gray-300">Variáveis Disponíveis:</p>
                            ...
                            <div className="flex gap-2 pt-4">
                                ...
                                <Button variant="outline" onClick={() => setSelectedTemplate(null)} className="border-neutral-700 text-white hover:bg-neutral-800">
                                    Cancelar
                                </Button>
                            </div>
                        </div>
            ...
            {/* Histórico de Envios */}
            <div className="mt-12">
                <h2 className="text-xl font-semibold mb-4 text-white">Próximos Envios Agendados</h2>
        ...
        <div className="bg-neutral-900 border border-neutral-700 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
                <thead className="bg-neutral-800">
                    <tr>
                        <th className="p-4 text-left text-neutral-300 font-medium">Cliente</th>
                        <th className="p-4 text-left text-neutral-300 font-medium">Template</th>
                        <th className="p-4 text-left text-neutral-300 font-medium">Enviar em</th>
                        <th className="p-4 text-left text-neutral-300 font-medium">Status</th>
                    </tr>
                </thead>
