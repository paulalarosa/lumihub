            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <Card className="max-w-md w-full bg-neutral-900 border-neutral-800 text-white">
                    <CardHeader>
                        ...
                        <CardDescription>Seu pagamento ainda está sendo processado.</CardDescription>
                    </CardHeader>
                </Card>
            </div>
        )
            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <Card className="max-w-md w-full bg-neutral-900 border-neutral-800 text-white">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>Não foi possível confirmar seu pagamento. Tente novamente.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button onClick={() => navigate('/planos')} className="w-full bg-purple-600 hover:bg-purple-700">
                            Tentar Novamente
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className="max-w-md w-full bg-neutral-900 border-neutral-800 text-white">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            ...
                            {customerEmail && <br />} Um email de confirmação foi enviado para {customerEmail}.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button onClick={() => navigate('/dashboard')} className="w-full bg-purple-600 hover:bg-purple-700">
                            Ir para o Dashboard
                        </Button>
                    </CardContent>
                </Card>
