...
import { Star, Phone, Mail, Instagram, MapPin, Calendar, Clock } from 'lucide-react';
...
export default function Microsite() {
    ...
    const schemaOrgData = useMemo(() => {
        ...
        return {
            ...
            "address": (microsite.address || microsite.city) ? {
                "@type": "PostalAddress",
    ...
    const visibleServices = (microsite.services || [])
        // @ts-ignore - is_visible might be missing in Service type but present in join
        .filter((s) => s.is_visible !== false)
        .sort((a, b) => (a.display_order || 0) - (b.display_order || 0));

    const sortedGallery = (microsite.gallery || [])
        .sort((a, b) => {
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content={microsite.meta_description || microsite.tagline || ''} />
                {/* @ts-ignore - meta_keywords array vs string issue */}
                {microsite.meta_keywords && Array.isArray(microsite.meta_keywords) && (
                    <meta name="keywords" content={microsite.meta_keywords.join(', ')} />
                )}
                <meta property="og:title" content={microsite.meta_title || microsite.business_name} />
                <meta property="og:description" content={microsite.meta_description || microsite.tagline || ''} />
                {microsite.og_image_url && <meta property="og:image" content={microsite.og_image_url} />}
            ...
            <div className="min-h-screen" style={{ backgroundColor: microsite.background_color || '#000', color: microsite.text_color || '#fff' }}>
                ...
                >
                    <div className="text-center z-10 max-w-3xl">
                        ...
                        {microsite.tagline && (
                            <p className="text-xl md:text-2xl mb-10 opacity-90">{microsite.tagline}</p>
                        )}
                        <div className="flex gap-4 justify-center flex-wrap">
                            {microsite.enable_booking && (
                                <Button
                                    ...
                                    style={{ backgroundColor: microsite.accent_color || '#fff', color: microsite.background_color || '#000' }}
                                >
                            ...
                            {microsite.whatsapp_link && (
                                <Button
                                    ...
                                    onClick={() => window.open(microsite.whatsapp_link!, '_blank')}
                                    style={{ borderColor: microsite.text_color || '#fff', color: microsite.text_color || '#fff' }}
                                >
                                    WhatsApp
                                </Button>
                            )}
                ...
                {microsite.enable_about && displayBio && (
                    <section className="py-20 px-4">
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="text-4xl font-bold mb-8" style={{ color: microsite.primary_color || '#fff' }}>
                                Sobre Mim
                            </h2>
                            <p className="text-lg leading-relaxed whitespace-pre-line opacity-90">{displayBio}</p>
                        </div>
                    </section>
                )}

                {microsite.enable_services && visibleServices.length > 0 && (
                    <section className="py-20 px-4" style={{ backgroundColor: `${microsite.primary_color}08` }}>
                        <div className="max-w-6xl mx-auto">
                            <h2 className="text-4xl font-bold mb-12 text-center" style={{ color: microsite.primary_color || '#fff' }}>
                                Serviços
                            </h2>
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {visibleServices.map((service) => (
                                    <div
                                        ...
                                        style={{ backgroundColor: microsite.background_color || '#000', border: `1px solid ${microsite.text_color}15` }}
                                    >
                                        {/* @ts-ignore - service.image_url might be missing in type */}
                                        {service.image_url && (
                                            // @ts-ignore
                                        ...
                                        <div className="p-6">
                                            ...
                                            {service.description && (
                                                <p className="mb-4 opacity-70 text-sm">{service.description}</p>
                                            )}
                                            <div className="flex items-center justify-between">
                                                {microsite.show_prices && service.price != null && (
                                                    <p className="text-2xl font-bold" style={{ color: microsite.accent_color || '#fff' }}>
                ...
                {microsite.enable_reviews && visibleTestimonials.length > 0 && (
                    <section className="py-20 px-4" style={{ backgroundColor: `${microsite.secondary_color}08` }}>
                        <div className="max-w-6xl mx-auto">
                            <h2 className="text-4xl font-bold mb-12 text-center" style={{ color: microsite.primary_color || '#fff' }}>
                                Depoimentos
                            </h2>
                            <div className="grid md:grid-cols-2 gap-6">
                                {visibleTestimonials.map((testimonial) => (
                                    <div
                                        ...
                                        style={{ backgroundColor: microsite.background_color || '#000', border: `1px solid ${microsite.text_color}10` }}
                                    >
                                        <div className="flex items-center gap-4 mb-4">
                                            {testimonial.client_photo_url ? (
                                                ...
                                                <div
                                                    ...
                                                    style={{ backgroundColor: `${microsite.primary_color}30`, color: microsite.primary_color || '#fff' }}
                                                >
                                            ...
                                            <div>
                                                ...
                                                {testimonial.event_type && (
                                                    <p className="text-sm opacity-60">{testimonial.event_type}</p>
                                                )}
                                            </div>
                                        </div>
                                        {testimonial.rating && (
                                        ...
                                        <p className="italic opacity-80 leading-relaxed">&ldquo;{testimonial.text}&rdquo;</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-5">
                                    {microsite.phone && (
                                        <a href={`tel:${microsite.phone}`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                                            <Phone className="w-5 h-5" style={{ color: microsite.accent_color || '#fff' }} />
                                            <span>{microsite.phone}</span>
                                        </a>
                                    )}
                                    {microsite.email && (
                                        <a href={`mailto:${microsite.email}`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                                            <Mail className="w-5 h-5" style={{ color: microsite.accent_color || '#fff' }} />
                                    ...
                                    {microsite.instagram_handle && (
                                        ...
                                        >
                                            <Instagram className="w-5 h-5" style={{ color: microsite.accent_color || '#fff' }} />
                                            <span>@{microsite.instagram_handle}</span>
                                        </a>
                                    )}
                                    {microsite.address && (
                                        <div className="flex items-start gap-3">
                                            <MapPin className="w-5 h-5 mt-0.5" style={{ color: microsite.accent_color || '#fff' }} />
                                            <div>
                                                <p>{microsite.address}</p>
                                                {microsite.city && microsite.state && (
                                                    <p className="text-sm opacity-60">{microsite.city}, {microsite.state}</p>
                                                )}
                                            </div>
                                        </div>
                                    )}
                                ...
                                {microsite.enable_booking && (
                                    ...
                                    >
                                        <h3 className="text-2xl font-bold mb-3">Agende seu Horário</h3>
                                        <p className="mb-6 opacity-70">Entre em contato via WhatsApp:</p>
                                        <Button
                ...
                <footer className="py-8 px-4 border-t" style={{ borderColor: `${microsite.text_color}15` }}>
