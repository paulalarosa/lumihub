...
export const GoogleCalendarCallback = () => {
    ...
    const handleCallback = async () => {
        try {
            ...
            if (data && !data.success) throw new Error(data.error || 'Exchange failed');
            ...
            <div className="text-center">
                {status === 'processing' && (
                    <>
                        ...
                        <h1 className="text-2xl text-white font-bold">Conectando com Google Calendar...</h1>
                        <p className="text-neutral-400 mt-2">Aguarde, estamos sincronizando seus eventos.</p>
                    </>
                )}
                ...
                {status === 'success' && (
                    <>
                        ...
                        <p className="text-neutral-400 mt-2">Redirecionando para a agenda...</p>
                    </>
                )}
                ...
                {status === 'error' && (
                    <>
                        ...
                        <p className="text-neutral-400 mt-2 mb-4">Não foi possível conectar sua conta Google.</p>
                        <button
