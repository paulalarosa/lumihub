...
const DragOverlay = memo(function DragOverlay({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center rounded-2xl border-2 border-dashed border-primary/50 bg-primary/5 animate-in fade-in duration-150">
...
export const ChatInput = memo(function ChatInput({
  ...
  const canSend =
    (value.trim().length > 0 || hasCompletedUploads) &&
    !isGenerating &&
    !hasPendingUploads
