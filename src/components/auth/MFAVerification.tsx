    ...
    useEffect(() => {
        const init = async () => {
            ...
            if (totpFactor) {
                ...
                toast.error("Nenhum método MFA encontrado. Entre em contato com o suporte.");
            }
        };
        init();
    }, [listFactors]);
    ...
    return (
        <div className="w-full max-w-md mx-auto space-y-6 p-6 bg-card border rounded-lg shadow-lg">
            <div className="flex flex-col items-center text-center space-y-2">
                ...
                <h1 className="text-2xl font-bold tracking-tight">Verificação de Segurança</h1>
            ...
            <form onSubmit={handleVerify} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={code.length !== 6 || isVerifying || !factorId}>
