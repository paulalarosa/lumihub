...
import { CheckCircle, ArrowRight, Sparkles, Calendar, User, Palette } from 'lucide-react';
...
export const OnboardingWizard = () => {
    ...
    useEffect(() => {
        if (onboarding && !onboarding.is_completed && !onboarding.has_seen_tour) {
            ...
            const savedStepIndex = ONBOARDING_STEPS.findIndex(s => s.id === onboarding.current_step);
            ...
            <DialogContent className="bg-neutral-900 border-neutral-800 max-w-2xl text-white sm:max-h-[90vh] overflow-y-auto">
                ...
                {currentStep.id === 'welcome' && (
                    <div className="space-y-4 text-center">
                        <p className="text-neutral-300">
                            Em menos de 5 minutos você estará pronta para gerenciar seus clientes,
                            agenda e contratos de forma profissional! ✨
                        </p>
                ...
                {currentStep.id === 'services' && (
                    <div className="text-center space-y-4">
                        <p className="text-neutral-300">
                            Você pode configurar seus serviços e preços depois no menu Configurações
                        </p>
                ...
                {currentStep.id === 'calendar' && (
                    <div className="text-center space-y-4">
                        ...
                        <Button variant="outline" size="lg" className="border-neutral-700 hover:bg-neutral-800 text-white">
                ...
                {currentStep.id === 'complete' && (
                    <div className="text-center space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-400">
                                Sua conta está configurada e você já pode começar a agendar seus primeiros eventos
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-neutral-800 rounded-lg text-left">
                                ...
                                <p className="font-semibold text-white">Cadastrar primeira cliente</p>
                            </div>
                            <div className="p-4 bg-neutral-800 rounded-lg text-left">
                                <p className="text-sm text-neutral-400 mb-1">Depois</p>
                                <p className="font-semibold text-white">Criar primeiro evento</p>
                            </div>
                        </div>
                    </div>
                )}
                ...
                <div className="flex gap-2 mt-6">
                    {currentStep.id !== 'complete' && (
                        <Button variant="ghost" onClick={handleSkip} className="flex-1 hover:bg-neutral-800 text-neutral-400">
                            Pular
                        </Button>
                    )}
