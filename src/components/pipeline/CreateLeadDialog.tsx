...
export const CreateLeadDialog = ({ isOpen, onClose }: CreateLeadDialogProps) => {
    const { user } = useAuth();
    ...
    const createLead = useMutation({
        mutationFn: async (data: LeadFormData) => {
            ...
            if (!stageId) throw new Error('Nenhum estágio de pipeline encontrado. Crie os estágios primeiro.');
            ...
            <DialogContent className="sm:max-w-[500px] bg-neutral-900 border-neutral-800 text-white">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
                    ...
                    <DialogFooter className="mt-6">
                        ...
                        <Button type="submit" disabled={isLoading} className="bg-primary hover:bg-primary/90 text-black font-semibold">
