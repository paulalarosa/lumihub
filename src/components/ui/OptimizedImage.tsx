...
export const OptimizedImage = ({ src, alt, className, width, height }: OptimizedImageProps) => {
    ...
    // Tiny base64 transparent pixel or blurred background
    const placeholder = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300"%3E%3Crect fill="%23171717" width="400" height="300"/%3E%3C/svg%3E';
        ...
        <div className={cn('relative overflow-hidden bg-neutral-900', className)}>
            ...
            {error && (
                <div className="flex flex-col items-center justify-center w-full h-full bg-zinc-950 border border-white/5 space-y-2">
                    <span className="text-[10px] text-zinc-600 font-mono uppercase tracking-widest">Load_Failure</span>
