    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative text-white hover:text-white hover:bg-white/10 rounded-none"
        >
      ...
      <PopoverContent
        className="w-80 p-0 bg-black border-white/20 text-white rounded-none shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)]"
        align="end"
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/20">
          ...
          {unreadCount > 0 && (
            <Badge
              variant="outline"
              className="bg-white text-black text-[10px] rounded-none border-0 font-mono"
            >
              {unreadCount} NEW
            </Badge>
          )}
        ...
        <ScrollArea className="h-[300px]">
          {loading ? (
            <div className="p-4 text-center text-xs font-mono text-gray-500 uppercase">
              Start...
            </div>
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    {notification.link && (
                      <Link
                        ...
                        className="text-[10px] text-white hover:underline decoration-white underline-offset-2 font-mono uppercase"
                      >
                        DETAILS -&gt;
                      </Link>
                    )}
