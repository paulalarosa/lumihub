...
import { Key, Eye, EyeOff, Trash2, CheckCircle, Info, ExternalLink } from 'lucide-react';
        ...
        <div className="space-y-8 font-mono">
            ...
            <Alert className="bg-blue-500/5 border-blue-500/20 rounded-none">
                ...
                <AlertDescription className="text-[10px] uppercase tracking-widest leading-relaxed">
                    <p className="text-white font-bold mb-1">BYOK - Bring Your Own Key Protocol</p>
                    <p className="text-zinc-500">
                        Utilize your own enterprise keys to optimize costs and bypass centralized limits.
                        All keys are encrypted and stored within your <span className="text-blue-400">local security context</span>.
                    </p>
                </AlertDescription>
            </Alert>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <Label className="text-[10px] uppercase font-bold tracking-[0.2em] text-zinc-400">Google Gemini Vault</Label>
                    {userAPIKeys.gemini && (
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <Label className="text-[10px] uppercase font-bold tracking-[0.2em] text-zinc-400">OpenAI Security Vault</Label>
                    {userAPIKeys.openai && (
                        <div className="flex items-center gap-1.5 text-[8px] text-emerald-500 uppercase font-black">
                            <CheckCircle className="w-3 h-3" />
                            Verified_Active
            ...
            <div className="p-4 bg-zinc-950 border border-white/5 space-y-3">
                ...
                <ul className="space-y-1.5">
                    {[
                        ...
                        <li key={idx} className="flex items-start gap-3 text-[8px] text-zinc-600 uppercase tracking-widest leading-relaxed">
