...
import { Cpu, Download, Trash2, Shield, Sparkles, Loader2 } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-neutral-400 text-[10px] uppercase tracking-wider">
                                Available exclusively on the <span className="text-purple-400 font-bold">Studio Plan</span>
                            </p>
                        </div>
                        <Button
                            size="sm"
        ...
        <div className="space-y-6 font-mono">
            ...
            <Alert className="bg-zinc-900/50 border-white/5 rounded-none">
                ...
                <AlertDescription className="text-[10px] uppercase tracking-widest leading-relaxed">
                    <p className="text-white font-bold mb-1">Local AI Engine Enabled ✨</p>
                    <p className="text-zinc-500">
                        Total privacy protocol: the model executes within your local environment using WebGPU.
                        No communication with external neural networks is established.
                    </p>
                </AlertDescription>
            </Alert>
                ...
                >
                    ...
                    <SelectContent className="bg-zinc-950 border-white/10 rounded-none">
                        {availableModels.map((model) => (
                            <SelectItem key={model.id} value={model.id} className="text-zinc-400 focus:bg-white focus:text-black">
                                <div className="flex flex-col py-1">
                                    <span className="font-bold text-[10px] uppercase">{model.name}</span>
            ...
            {isLoading && (
                <div className="space-y-3 p-4 bg-zinc-900/30 border border-white/5">
                    ...
                    <p className="text-[8px] text-zinc-600 animate-pulse uppercase">Establishing local neural weights...</p>
                </div>
            )}
            ...
            <div className="p-4 bg-black/40 border border-white/5 space-y-3">
                ...
                <ul className="space-y-2">
                    {[
                        ...
                        <li key={idx} className="flex items-center gap-2 text-[8px] text-zinc-600 uppercase tracking-widest">
