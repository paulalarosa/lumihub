    ...
    return (
        <div className="bg-zinc-950/50 border border-white/10 rounded-none overflow-hidden backdrop-blur-sm">
            <div className="p-3 border-b border-white/5 bg-white/5">
                <h4 className="text-[10px] font-mono uppercase tracking-[0.2em] text-white font-bold">Protocol Schedule</h4>
            </div>

            <div className="divide-y divide-white/5">
                {events.length === 0 ? (
                    <div className="p-4 text-center">
                        <p className="text-[10px] font-mono uppercase text-zinc-600">No events detected in stream</p>
                    </div>
                ) : (
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                {event.client && (
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] text-zinc-400 font-mono italic">{event.client}</span>
                                    </div>
                                )}
                            </div>
                        </div>
