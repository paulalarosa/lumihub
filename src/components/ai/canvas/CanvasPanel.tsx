                ...
                <div className="flex items-center gap-3 flex-1">
                    <div className="w-9 h-9 bg-white/5 border border-white/10 flex items-center justify-center rounded-none rotate-45">
                        <div className="-rotate-45">
                            {activeCanvas.type === 'contract' ? <FileText className="w-4 h-4 text-purple-400" /> :
                                activeCanvas.type === 'html' ? <Code className="w-4 h-4 text-blue-400" /> :
                ...
                <div className="flex gap-1 bg-black p-1 border border-white/5">
                    <Button
                        ...
                        className={cn(
                            ...
                            viewMode === 'edit' ? 'bg-white text-black hover:bg-zinc-200' : 'text-zinc-500 hover:text-white'
                        )}
                    >
                        Edit
                    </Button>
                    <Button
                        ...
                        className={cn(
                            'text-[10px] font-mono uppercase tracking-[0.2em] rounded-none h-7 px-3',
                            viewMode === 'preview' ? 'bg-white text-black hover:bg-zinc-200' : 'text-zinc-500 hover:text-white'
                        )}
                    >
                        Preview
                    </Button>
            ...
            <div className="p-3 border-t border-white/5 bg-black text-[8px] font-mono uppercase tracking-[0.3em] font-bold text-zinc-400 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white">
                        {new Date(activeCanvas.updatedAt).toLocaleTimeString('pt-BR', { hour12: false })}
                    </span>
                </div>
            </div>
        </div>
