                ...
                <div className="min-h-screen bg-black flex items-center justify-center p-6 font-mono">
                    <div className="max-w-md w-full border border-red-500/20 bg-zinc-950 p-8 space-y-6">
                        ...
                        <div className="flex items-center justify-between opacity-30 pt-4 border-t border-white/5">
                            <span className="text-[7px] text-white uppercase tracking-[0.4em]">Error_Code: 0x882A_NULL</span>
                            <span className="text-[7px] text-zinc-600 uppercase tracking-widest">Khaos Kontrol Enterprise</span>
                        </div>
                    </div>
                </div>
            );
