      ...
      <DialogContent className="sm:max-w-[1000px] w-[95vw] h-[90vh] sm:h-auto bg-[#050505] text-white border-white/10 flex flex-col rounded-none p-0 overflow-hidden">
        <DialogHeader className="p-6 border-b border-white/10 bg-black/50">
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-2xl font-serif font-light tracking-wide text-white">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-6 space-y-8 bg-[#050505]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <Label className="text-white/40 font-mono text-[10px] uppercase tracking-widest">
                Projeto Vinculado
              </Label>
              <select
          ...
          <Tabs
            value={mode}
            onValueChange={(v) => setMode(v as 'digital' | 'upload')}
          ...
          >
            ...
            <TabsContent value="upload" className="mt-8">
              <div className="border border-dashed border-white/20 h-[400px] flex flex-col items-center justify-center bg-white/[0.02] hover:bg-white/[0.05] transition-colors group cursor-pointer relative">
                ...
                <label
                  htmlFor="file-upload"
                  className="cursor-pointer flex flex-col items-center p-6 w-full h-full justify-center absolute inset-0 z-10"
                >
                  {file ? (
                    <>
                      ...
                      <span className="text-[10px] text-white/40 mt-3 font-mono uppercase tracking-widest group-hover:text-white transition-colors">
                    ...
                    <>
                      ...
                      <span className="text-white/60 font-serif text-lg tracking-wide group-hover:text-white transition-colors">
                        UPLOAD DE PDF
                      </span>
                      <span className="text-[10px] text-white/30 mt-3 font-mono uppercase tracking-widest">
        ...
        <DialogFooter className="p-6 border-t border-white/10 bg-black/50 gap-4">
          <Button
            ...
            className="text-white/40 hover:text-white hover:bg-transparent font-mono text-xs uppercase tracking-widest rounded-none"
          >
            CANCELAR
          </Button>
          <Button
